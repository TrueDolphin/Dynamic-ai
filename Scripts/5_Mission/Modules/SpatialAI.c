  class SpatialAI {
    ...
    void Spatial_Spawn(PlayerBase player, int bod, Spatial_Group Group) {
      ...
      Spatial_message(player, bod, group);
    ...
    void Spatial_message(PlayerBase player, int SpawnCount, Spatial_Group group) {
      if (!player) return;
      ...
      //} else {
      title = m_Spatial_Groups.MessageTitle;
      text = m_Spatial_Groups.MessageText;
      //}
